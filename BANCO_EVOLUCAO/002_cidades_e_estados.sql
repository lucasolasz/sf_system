...
CREATE TABLE `tb_cidades` (
  ...
  `fk_estado` int(2) unsigned zerofill NOT NULL default '00',
...
CREATE TABLE `tb_estados` (
  ...
  `ds_uf` varchar(10) NOT NULL default '',
  `ds_estado` varchar(20) NOT NULL default '',
  PRIMARY KEY  (`id_estado`)
) CHARACTER SET utf8 COLLATE UTF8_GENERAL_CI AUTO_INCREMENT=28 ;
