    ...
    <body class="text-center py-3">
        ...
        <main class="form-signin">
            <form name="form_sf_system" id="form_sf_system" method="POST" >
                ...
                <p> Esqueceu a senha? <a href="/consulta/cadastro/usuario/esqueci_senha.php" style="color: black;"> Clique aqui! </a> </p>
        ...
        <?php 
            ...
            if(isset($_SESSION['corMensagem'])){
               ...
               unset($_SESSION['corMensagem']);
            } else
                $corMensagem = "firebrick";
               
        ?>    
          
        <div class="container">
            <p class="text-center text-light" style="background-color: <?php echo $corMensagem ?>">
            <?php
